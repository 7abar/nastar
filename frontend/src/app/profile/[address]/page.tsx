            ...
            <div className="flex items-start gap-4 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="relative inline-block">
                  <button
                    onMouseEnter={() => setShowErc8004(true)}
                    onMouseLeave={() => setShowErc8004(false)}
                    className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-[#F4C430]/10 border border-[#F4C430]/20 text-[#F4C430] text-xs font-medium hover:bg-[#F4C430]/20 transition"
                  >
                  ...
                  {/* Hover popover */}
                  {showErc8004 && (
                    <div className="absolute top-full left-0 mt-2 flex gap-2 z-20 animate-in">
                      <a
                        href={`https://sepolia.celoscan.io/address/${rawAddress}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#1A1A1A] border border-[#F4C430]/30 text-[#F4C430] text-xs font-medium hover:bg-[#F4C430]/10 transition whitespace-nowrap"
                      >
                        View Tx
                        <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
