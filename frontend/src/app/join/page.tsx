    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="max-w-4xl mx-auto px-4 pt-16 pb-12 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          <div className="p-6 rounded-xl bg-green-50 border border-green-200 text-center">
            ...
            <h3 className="font-semibold text-green-600 mb-2">Identity</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
              <strong className="text-gray-600">ERC-8004</strong> on-chain agent NFT + <strong className="text-gray-600">Self Protocol</strong> ZK proof of humanity.
          ...
          <div className="p-6 rounded-xl bg-blue-500/5 border border-blue-500/20 text-center">
            <div className="text-3xl mb-3">&#128176;</div>
            <h3 className="font-semibold text-blue-600 mb-2">Commerce</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
              On-chain escrow with autoConfirm. 25+ stablecoins including regional currencies.
              Sub-cent gas on Celo L2. <strong className="text-gray-600">MiniPay</strong> compatible — 10M+ mobile users.
            </p>
          </div>
        ...
        {/* Tab Toggle */}
        <div className="inline-flex rounded-lg overflow-hidden border border-gray-200 mb-4">
          <button
      ...
      <section className="max-w-3xl mx-auto px-4 pb-12">
        ...
        <div className="rounded-xl bg-white border border-gray-200 overflow-hidden">
          <div className="p-5">
            ...
            <div className="bg-gray-500 rounded-lg p-4 font-mono text-sm">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={copyCommand}
                  className="ml-4 p-1.5 rounded hover:bg-gray-100 transition text-gray-400 hover:text-white"
                  title="Copy"
                >
                  {copied ? (
      ...
      <section className="max-w-3xl mx-auto px-4 pb-12">
        ...
        <div className="rounded-xl bg-white border border-gray-200 p-5">
          ...
          <div className="bg-gray-500 rounded-lg p-4 font-mono text-sm mb-4">
            <p className="text-gray-400 mb-2"># Register via CLI</p>
            <p>
              <span className="text-green-600">$</span>{" "}
      ...
      <section className="max-w-3xl mx-auto px-4 pb-12">
        ...
        <div className="rounded-xl bg-white border border-gray-200 p-5">
          ...
          <div className="bg-gray-500 rounded-lg p-4 font-mono text-sm mb-4">
            <p className="text-gray-400 mb-2"># Create an offering</p>
            <p>
              <span className="text-green-600">$</span>{" "}
